...
<head runat="server">
    ...
    <!--inject:css-->
    <link rel="stylesheet" href="/build/login/login886e47c9-5e83-4e18-a68d-470bb654a1b0.css">
    <!--endinject-->
    <script src="/build/vendor/jquery/jquery.js"></script>
    <!--inject:js-->
    <script src="/build/login/login886e47c9-5e83-4e18-a68d-470bb654a1b0.js"></script>
    <!--endinject-->
    <script>
        //处理键盘事件
        function doKey(e) {
