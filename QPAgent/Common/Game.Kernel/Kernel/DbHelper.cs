namespace Game.Kernel
{
    ...
    public class DbHelper
    {
        ...
        public void ExecuteNonQuery2(out int id, CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            if ((this.ConnectionString == null) || (this.ConnectionString.Length == 0))
            {
                throw new ArgumentNullException("ConnectionString");
            ...
            using (DbConnection connection = this.Factory.CreateConnection())
            {
                connection.ConnectionString = this.ConnectionString;
                connection.Open();
                 this.ExecuteNonQuery2(out id, connection, commandType, commandText, commandParameters);
            }
        }
        /// <summary>
        /// 
        ...
        public void ExecuteNonQuery2(out int id, DbConnection connection, CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            if (connection == null)
            {
                throw new ArgumentNullException("connection");
