namespace Game.Kernel
{
    ...
    public class TableProvider : BaseDataProvider, ITableProvider
    {
        ...
        //public void InsertAwardCards(AwardCards model)
        //{

        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("insert into AwardCards(");
        //    strSql.Append("Price,CardNo,CardPassWord,Status)");
        //    strSql.Append(" values ("+model.Price+",'"+model.CardNo+"','"+model.CardPassWord+"',"+model.Status+")");
        //    //strSql.Append("@Price,@CardNo,@CardPassWord,@Status)");
        //    //strSql.Append(";select @@IDENTITY");
        //    //SqlParameter[] parameters = {
        //    //        new SqlParameter("@Price", SqlDbType.Int,4),
        //    //        new SqlParameter("@CardNo", SqlDbType.NVarChar,100),
        //    //        new SqlParameter("@CardPassWord", SqlDbType.NVarChar,100),
        //    //       new SqlParameter("@Status",SqlDbType.Int,4)
        //    //                            };
        //    //parameters[0].Value = model.Price;
        //    //parameters[1].Value = model.CardNo;
        //    //parameters[2].Value = model.CardPassWord;
        //    //parameters[3].Value = model.Status;


        //    int obj = this.Database.ExecuteNonQuery(strSql.ToString());
