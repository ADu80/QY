...
{
    /// <summary>
    /// 实体类 vw_RecordGrantGameID。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class vw_RecordGrantGameID
    {
        #region 常量
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "vw_RecordGrantGameID";
        ...
        /// <summary>
        /// 初始化vw_RecordGrantGameID
        /// </summary>
        public vw_RecordGrantGameID()
        {
            m_Accounts = "";
