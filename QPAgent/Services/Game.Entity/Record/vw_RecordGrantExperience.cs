...
{
    /// <summary>
    /// 实体类 vw_RecordGrantExperience。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class vw_RecordGrantExperience
    {
        #region 常量
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "vw_RecordGrantExperience";
        public const string _UserName = "UserName";
        public const string _Accounts = "Accounts";
        public const string _AfterExperience = "AfterExperience";
        /// <summary>
        /// 记录标识
        /// </summary>
        ...
        /// <summary>
        /// 初始化vw_RecordGrantExperience
        /// </summary>
        public vw_RecordGrantExperience()
        {
            m_Accounts = "";
        ...
        {
            get { return m_AfterExperience; }
            set { m_AfterExperience = value; }
        }
        /// <summary>
        /// 记录标识
        /// </summary>
