...
{
    /// <summary>
    /// 实体类 vw_ShareDetailInfo。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class vw_ShareDetailInfo
    {
        #region 常量
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "vw_ShareDetailInfo";
        ...
        /// <summary>
        /// 初始化vw_ShareDetailInfo
        /// </summary>
        public vw_ShareDetailInfo()
        {
            m__CardName = string.Empty;
            m_ShareName = string.Empty;
            m_detailID = 0;
            m_operUserID = 0;
            m_shareID = 0;
            m_userID = 0;
        ...
        {
            get { return m__CardName; }
            set { m__CardName = value; }
        }
