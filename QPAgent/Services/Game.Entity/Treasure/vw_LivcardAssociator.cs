...
{
    /// <summary>
    /// 实体类 vw_LivcardAssociator。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class vw_LivcardAssociator
    {
        #region 常量
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "vw_LivcardAssociator";
        ...
        /// <summary>
        /// 初始化vw_LivcardAssociator
        /// </summary>
        public vw_LivcardAssociator()
        {
            m_CardName = "";
            m_cardID = 0;
            m_serialID = "";
