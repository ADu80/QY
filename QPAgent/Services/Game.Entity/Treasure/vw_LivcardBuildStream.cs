...
{
    /// <summary>
    /// 实体类 vw_LivcardBuildStream。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class vw_LivcardBuildStream
    {
        #region 常量
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "vw_LivcardBuildStream";
        ...
        /// <summary>
        /// 初始化vw_LivcardBuildStream
        /// </summary>
        public vw_LivcardBuildStream()
        {
            m_CardName = "";
            m_TotalPrice = 0;
            m_buildID = 0;
