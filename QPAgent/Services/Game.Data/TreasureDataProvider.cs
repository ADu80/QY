...
namespace Game.Data
{
    ...
    public class TreasureDataProvider : BaseDataProvider, ITreasureDataProvider
    {
        ...
        private ITableProvider aidplyscore;

        private ITableProvider aidSpreadAddress;
            ...
            : base(connString)
        {
            ...
            aidplyscore = GetTableProvider(PayTransfers.Tablename);

            aidSpreadAddress = GetTableProvider(SpreadAdd.Tablename);
        }
        #endregion
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_LivcardBuildStream.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_LivcardAssociator.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_OnLineOrder.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        /// <param name="orderby"></param>
        /// <returns></returns>
        public PagerSet PlyOrderList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(PayTransfers.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        /// </summary>
        /// <param name="sqlQuery"></param>
        public void DeletePlyOrder(string sqlQuery)
        {
            aidplyscore.Delete(sqlQuery);
        }
        /// <summary>
        /// 获取快钱返回记录
        /// </summary>
        ...
        public ReturnVBDetailInfo GetVBDetailInfo(int detailID)
        {
            ...
            return detailInfo;
            //ReturnVBDetailInfo detailfo = aideVBDetailProvider.GetObject<ReturnVBDetailInfo>(sqlQuery);
        }
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_ShareDetailInfo.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        public PagerSet GetGlobalShareList(int pageIndex, int pageSize, string condition, string orderby)
        {
            ...
            //PagerParameters page = new PagerParameters(GlobalShareInfo.Tablename,orderby,condition,pageIndex.);
            return GetPagerSet2(pagerPrams);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameScoreInfo.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        /// <summary>
        /// 获取用户金币信息
        ...
        public void UpdateInsureScore(GameScoreInfo gameScoreInfo)
        {
            ...
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("Score", gameScoreInfo.Score));
        ...
        /// </summary>
        /// <param name="gameScoreInfo"></param>
        public void UpdateInsure(GameScoreInfo gameScoreInfo)
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("UPDATE GameScoreInfo SET ")
        ...
        public Message GrantTreasure_Agent(int byUserID, string strUserIdList, int UserIDListCount, int intGold, int intMasterID, string strReason, string strIP)
        {
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("byUserID", byUserID));
            prams.Add(Database.MakeInParam("strUserIDList", strUserIdList));
            prams.Add(Database.MakeInParam("UserIDListCount", UserIDListCount));
            prams.Add(Database.MakeInParam("dwAddGold", intGold));
            prams.Add(Database.MakeInParam("dwMasterID", intMasterID));
            prams.Add(Database.MakeInParam("strReason", strReason));
            prams.Add(Database.MakeInParam("strClientIP", strIP));

            Message msg = MessageHelper.GetMessage(Database, "NET_PM_GrantTreasure_Agent", prams);
            return msg;
        }
        ...
        /// <param name="intGold"></param>
        /// <param name="intMasterID"></param>
        /// <param name="strReason"></param>
        /// <param name="strIP"></param>
        /// <returns></returns>
        public Message GrantTreasureScore(string strUserIdList, int intGold, int intMasterID, string strReason, string strIP)
        {
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("UserID", strUserIdList));
            prams.Add(Database.MakeInParam("AddGold", intGold));
            prams.Add(Database.MakeInParam("MasterID", intMasterID));
            prams.Add(Database.MakeInParam("Reason", strReason));
            prams.Add(Database.MakeInParam("ClientIP", strIP));


            Message msg = MessageHelper.GetMessage(Database, "NET_PM_GrantTreasureScore", prams);
            return msg;
        }
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordDrawInfo.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        /// <summary>
        /// 获取玩家游戏记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordDrawScore.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameScoreLocker.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        /// <summary>
        /// 删除卡线记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_AndroidManager.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordUserInout.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordInsure.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters("vw_RecordSpreadInfo", orderby, condition, pageIndex, pageSize);
        ...
        ///// <param name="buildID"></param>
        ///// <returns></returns>
        //public RecordSpreadInfo GetRecordSpreadInfo(int UserId)
        //{
        //    string sqlQuery = string.Format("(NOLOCK) WHERE TypeId=10 and  UserId='{0}'", UserId);
        //    RecordSpreadInfo recordSpreadInfo = aideGlobalSpreadInfoProvider.GetObject<RecordSpreadInfo>(sqlQuery);
        //    return recordSpreadInfo;
        //}
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet GetStatInfo_Agent(int UserID)
        {
            DataSet ds;
            List<DbParameter> paramlist = new List<DbParameter>() {
            Database.MakeInParam("UserID", UserID) };
            Database.RunProc("NET_PM_StatInfo_Agent", paramlist, out ds);
            return ds;
        }

        public DataSet GetStatInfo_Admin()
        {
            DataSet ds;
            Database.RunProc("NET_PM_StatInfo_Admin", out ds);
            return ds;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet GetStatInfo2(int UserID)
        {
            DataSet ds;
            List<DbParameter> paramlist = new List<DbParameter>() {
            Database.MakeInParam("UserID", UserID) };
            Database.RunProc("NET_PM_StatInfo2", paramlist, out ds);
            return ds;
        }
        ...
        {
            string sqlQuery = @"SELECT K.KindName,T1.KindID,Revenue FROM (SELECT KindID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) GROUP BY KindID) T1 LEFT JOIN QPPlatformDB.dbo.GameKindItem K ON T1.KindID=K.KindID  order by T1.KindID";
            DataSet ds;
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable IsAndroidGameRevenue()
        {
            string sqlQuery = @"SELECT K.KindName,T1.KindID,Revenue FROM (SELECT KindID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) WHERE UserID IN (select UserID from QPAccountsDB.dbo.AccountsInfo WHERE IsAndroid=1) GROUP BY KindID) T1 LEFT JOIN QPPlatformDB.dbo.GameKindItem K ON T1.KindID=K.KindID  order by T1.KindID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable UnIsAndroidGameRevenue()
        {
            string sqlQuery = @"SELECT K.KindName,T1.KindID,Revenue FROM (SELECT KindID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) WHERE UserID IN (select UserID from QPAccountsDB.dbo.AccountsInfo WHERE IsAndroid=0) GROUP BY KindID) T1 LEFT JOIN QPPlatformDB.dbo.GameKindItem K ON T1.KindID=K.KindID  order by T1.KindID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        {
            string sqlQuery = @"SELECT G.ServerName,T1.ServerID,Revenue FROM (SELECT ServerID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) GROUP BY ServerID) T1 LEFT JOIN QPPlatformDB.dbo.GameRoomInfo G ON T1.ServerID=G.ServerID  order by T1.ServerID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable IsAndroidRoomRevenue()
        {
            string sqlQuery = @"SELECT G.ServerName,T1.ServerID,Revenue FROM (SELECT ServerID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) WHERE UserID IN (select UserID from QPAccountsDB.dbo.AccountsInfo WHERE IsAndroid=1)  GROUP BY ServerID) T1 LEFT JOIN QPPlatformDB.dbo.GameRoomInfo G ON T1.ServerID=G.ServerID  order by T1.ServerID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable UnIsAndroidRoomRevenue()
        {
            string sqlQuery = @"SELECT G.ServerName,T1.ServerID,Revenue FROM (SELECT ServerID,SUM(Revenue) AS Revenue FROM RecordUserInout(NOLOCK) WHERE UserID IN (select UserID from QPAccountsDB.dbo.AccountsInfo WHERE IsAndroid=0) GROUP BY ServerID) T1 LEFT JOIN QPPlatformDB.dbo.GameRoomInfo G ON T1.ServerID=G.ServerID  order by T1.ServerID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        {
            string sqlQuery = @"SELECT K.KindName,T1.KindID,Waste FROM (SELECT KindID,SUM(Waste) AS Waste FROM RecordDrawInfo(NOLOCK) GROUP BY KindID) T1 LEFT JOIN QPPlatformDB.dbo.GameKindItem K ON T1.KindID=K.KindID order by T1.KindID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        {
            string sqlQuery = @"SELECT G.ServerName,T1.ServerID,Waste FROM (SELECT ServerID,SUM(Waste) AS Waste FROM RecordDrawInfo(NOLOCK) GROUP BY ServerID) T1 LEFT JOIN QPPlatformDB.dbo.GameRoomInfo G ON T1.ServerID=G.ServerID";
            DataSet ds;
            ds = Database.ExecuteDataset(CommandType.Text, sqlQuery);
            return ds.Tables[0];
        }
        ...
        /// <param name="orderID"></param>
        /// <returns></returns>
        public SpreadAdd GetSpreadAddressInfo(int id)
        {
            string sqlQuery = string.Format("(NOLOCK) WHERE id= '{0}'", id);
            SpreadAdd spreadAdd = aidSpreadAddress.GetObject<SpreadAdd>(sqlQuery);
            return spreadAdd;
        }
        ...
        /// <param name="orderby"></param>
        /// <returns></returns>
        public PagerSet GetSpreadAddressList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(SpreadAdd.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        /// </summary>
        /// <param name="sqlQuery"></param>
        public void DeleteSpreadAddress(string sqlQuery)
        {
            aidSpreadAddress.Delete(sqlQuery);
        }
        ...
        public void InsertSpreadAddress(SpreadAdd spreadAdd)
        {
            DataRow dr = aidSpreadAddress.NewRow();

            dr[SpreadAdd._UserID] = spreadAdd.UserID;
            dr[SpreadAdd._Address] = spreadAdd.Address;
            dr[SpreadAdd._Addtime] = spreadAdd.Addtime;


            aidSpreadAddress.Insert(dr);


        }


        public void UpdateSpreadAddress(SpreadAdd spreadAdd)
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("UPDATE SpreadAddress SET ")
            ...
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("UserID", spreadAdd.UserID));
            prams.Add(Database.MakeInParam("Address", spreadAdd.Address));
            prams.Add(Database.MakeInParam("Id", spreadAdd.Id));
        ...
        /// <param name="orderby"></param>
        /// <returns></returns>
        public PagerSet GetMobliePayList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(MobliePay.Tablename, orderby, condition, pageIndex, pageSize);

            return GetPagerSet2(pagerPrams);
        }


        public PagerSet GetRecordGrantTreasureScoreList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordGrantTreasureScore.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        ...
        /// </summary>      
        /// <param name="strUserIdList">赠送对象</param>
        /// <param name="strRcard">赠送房卡</param>
        /// <param name="intMasterID">操作者ID</param>
        /// <param name="strReason">赠送原因</param>
        /// <param name="strIP">IP地址</param>
        /// <returns></returns>
        public Message GrantRoomcard(string strUserIdList, int intRcard, int intMasterID, string strReason, string strIP)
        {
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("strUserIDList", strUserIdList));
            prams.Add(Database.MakeInParam("dwAddRcard", intRcard));
            prams.Add(Database.MakeInParam("dwMasterID", intMasterID));
            prams.Add(Database.MakeInParam("strReason", strReason));
            prams.Add(Database.MakeInParam("strClientIP", strIP));

            Message msg = MessageHelper.GetMessage(Database, "NET_PM_GrantRcard", prams);
            return msg;
        }

        public Message GrantRoomcard_Agent(string strUserIdList, int UserIDListCount, int intRcard, int intMasterID, string strReason, string strIP)
        {
            var prams = new List<DbParameter>();
            prams.Add(Database.MakeInParam("byUserID", intMasterID));
            prams.Add(Database.MakeInParam("strUserIDList", strUserIdList));
            prams.Add(Database.MakeInParam("UserIDListCount", UserIDListCount));
            prams.Add(Database.MakeInParam("dwAddRcard", intRcard));
            prams.Add(Database.MakeInParam("dwMasterID", intMasterID));
            ...
            Message msg = MessageHelper.GetMessage(Database, "NET_PM_GrantRcard_Agent", prams);
            return msg;
        }

        public PagerSet GetReportRecharge(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetRecharge", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportGift(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetGift", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportLoginLog(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetLoginLog", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportRichChange(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetRichChange", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportPlayGame(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetPlayGame", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportGameWaste(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetGameWaste", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportAllSum(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetAllSum", pageIndex, pageSize, conditions);
        }
        public PagerSet GetReportAllSum_Gamer(int pageIndex, int pageSize, Dictionary<string, object> conditions)
        {
            return RunProc("p_Report_GetAllSum_Gamer", pageIndex, pageSize, conditions);
        }
    }
