...
namespace Game.Data
{
    ...
    public class RecordDataProvider : BaseDataProvider, IRecordDataProvider
    {
        ...
        private ITableProvider aideRecordSendProperty;
        #endregion
            ...
            : base( connString )
        {
            ...
            aideRecordSendProperty = GetTableProvider(RecordSendProperty.Tablename);
        }
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordAccountsExpend.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_RecordPasswdExpend.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2( pagerPrams );
        }
        /// <summary>
        /// 新增一条记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantTreasure.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        /// <summary>
        /// 新增一条赠送金币记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantMember.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        /// <summary>
        /// 新增一条赠送会员记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantExperience.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        /// <summary>
        /// 新增一条赠送经验记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantGameScore.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        #endregion
        #region 清零积分记录
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantClearFlee.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        #endregion
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordConvertPresent.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        #endregion
        ...
        {
            PagerParameters pagerPrams = new PagerParameters( vw_RecordGrantGameID.Tablename, orderby, condition, pageIndex, pageSize );
            return GetPagerSet2( pagerPrams );
        }
        /// <summary>
        /// 赠送靓号
        ...
        public PagerSet GetRecordSendPropertyList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(RecordSendProperty.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
