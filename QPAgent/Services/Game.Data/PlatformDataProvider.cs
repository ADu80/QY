...
namespace Game.Data
{
    ...
    public class PlatformDataProvider : BaseDataProvider, IPlatformDataProvider
    {
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameTypeItem.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameNodeItem.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GamePageItem.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameKindItem.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        public void InsertKindList()
        {
            /// DataRow dt = aideGameGameItemProvider.NewRow();
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GameRoomInfo.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        {
            PagerParameters pagerPrams = new PagerParameters(vw_GlobalPlayPresent.Tablename, orderby, condition, pageIndex, pageSize);
        ...
        public DataTable GetGameItemList()
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("SELECT GameID,GameName FROM dbo.GameGameItem");
            DataSet ds= Database.ExecuteDataset(sb.ToString());
            return ds.Tables[0];
        }

        public DataTable GetGameRoomList()
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("SELECT ServerID,ServerName,GameID FROM dbo.GameRoomInfo");
            DataSet ds = Database.ExecuteDataset(sb.ToString());
            return ds.Tables[0];
        }
    }
