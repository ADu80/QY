...
namespace Game.Data
{
    ...
    public class AccountsDataProvider : BaseDataProvider, IAccountsDataProvider
    {
        ...
        public bool IsNickNameExist(string nickName)
        {
            ...
            AccountsInfo user = Database.ExecuteObject<AccountsInfo>(sqlQuery, prams);
            if (user == null)
            {
                return true;
            }
        ...
        public PagerSet GetAccountsList1(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters("vw_AccountSilver", orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        public PagerSet GetAccountsList2(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters("vw_AccountSilver_User", orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        /// <summary>
        /// 获得用户名
        ...
        /// 获取用户基本信息
        /// </summary>
        /// <param name="LastLogonMachine">登录机器</param>
        /// <returns></returns>
        public AccountsInfo GetLastLogonMachine(string LastLogonMachine)
        {
            string sqlQuery = string.Format("(NOLOCK) WHERE LastLogonMachine= N'{0}'", LastLogonMachine);
            AccountsInfo model = aideAccountsProvider.GetObject<AccountsInfo>(sqlQuery);
            if (model != null)
                return model;
            else
        ...
        public void DeleteAccountsProvider(string sqlQuery)
        {
        ...
        public Message AddAccount(AccountsInfo account, IndividualDatum datum)
        {
            ...
            prams.Add(Database.MakeInParam("SpreaderID", account.SpreaderID));
            prams.Add(Database.MakeInParam("AgentID", account.AgentID));
        ...
        /// <param name="datum">IndividualDatum实体</param>
        /// <returns></returns>
        public Message AddSilver(AccountsInfo account, IndividualDatum datum)
        {
            var prams = new List<DbParameter>();
            ...
            Message msg = MessageHelper.GetMessage(Database, "[NET_PM_AddSilver]", prams);
            return msg;
        }
        ...
        /// <param name="datum">IndividualDatum实体</param>
        /// <returns></returns>
        public Message AddSilver(int UserID, int InvitCode, AccountsInfo account, IndividualDatum datum, Base_Users users)
        {
            var prams = new List<DbParameter>();
            ...
            prams.Add(Database.MakeInParam("SpreaderID", account.SpreaderID));
            prams.Add(Database.MakeInParam("IvitCode", InvitCode));
            prams.Add(Database.MakeInParam("Created", DateTime.Now));
            prams.Add(Database.MakeInParam("Creator", UserID));
            prams.Add(Database.MakeInParam("Modified", DateTime.Now));
            prams.Add(Database.MakeInParam("Modifior", UserID));

            prams.Add(Database.MakeInParam("canHasSubAgent", users.canHasSubAgent));
            prams.Add(Database.MakeInParam("AgentLevelLimit", users.AgentLevelLimit));
            prams.Add(Database.MakeInParam("GradeID", users.GradeID));
            prams.Add(Database.MakeInParam("RoleID", users.RoleID));
            prams.Add(Database.MakeInParam("Percentage", users.Percentage));

            Message msg = MessageHelper.GetMessage(Database, "[NET_PM_AddSilverNew]", prams);
            return msg;
        }
        ...
        /// <param name="datum">IndividualDatum实体</param>
        /// <returns></returns>
        public Message AddSilverUser(AccountsInfo account, IndividualDatum datum)
        {
            var prams = new List<DbParameter>();
            ...
            Message msg = MessageHelper.GetMessage(Database, "[NET_PM_AddSilver_User]", prams);
            return msg;
        }
        /// <summary>
        /// 添加玩家信息
        ...
        /// <param name="datum">IndividualDatum实体</param>
        /// <returns></returns>
        public Message AddVipUser(AccountsInfo account, IndividualDatum datum)
        {
            var prams = new List<DbParameter>();
            ...
            Message msg = MessageHelper.GetMessage(Database, "[NET_PM_AddVip_User]", prams);
            return msg;
        }
        /// <summary>
        ///  更新用户基本信息
        ...
        public PagerSet GetIdentifierList(int pageIndex, int pageSize, string condition, string orderby)
        {
            PagerParameters pagerPrams = new PagerParameters(ReserveIdentifier.Tablename, orderby, condition, pageIndex, pageSize);
            return GetPagerSet2(pagerPrams);
        }
        #endregion
