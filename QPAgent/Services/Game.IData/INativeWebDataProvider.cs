...
namespace Game.IData
{
    ...
    public interface INativeWebDataProvider //: IProvider
    {
        ...
        #region 登陆奖励管理
        PagerSet GetRewardList(int pageIndex, int pageSize, string condition, string orderby);
        void InsertReward(Reward info);
        void UpdateReward(Reward Awardinfo);
        Reward GetRewardInfo(int Id);
        #endregion


        #region logo管理
        PagerSet GetContentist(int pageIndex, int pageSize, string condition, string orderby);
        Contents GetContentInfo(int id);
        void InsertContent(Contents info);
        void UpdateContent(Contents info);
        void DeleteContent(string sqlQuery);
        #endregion
    }
}
