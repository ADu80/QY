...
namespace Game.IData
{
    ...
    public interface ITreasureDataProvider //: IProvider
    {
        ...
        /// <param name="orderby"></param>
        /// <returns></returns>
        PagerSet PlyOrderList(int pageIndex, int pageSize, string condition, string orderby);
        ...
        /// </summary>
        /// <param name="sqlQuery"></param>
        void DeletePlyOrder(string sqlQuery);
        ...
        Message GrantTreasure_Agent(int byUserID, string strUserIdList, int UserIDListCount, int intGold, int intMasterID, string strReason, string strIP);
        /// <summary>
        /// 赠送积分
        /// </summary>
        /// <param name="userID"></param>
        ...
        /// </summary>
        /// <returns></returns>
        DataSet GetStatInfo2(int UserID);
        ...
        /// </summary>
        /// <returns></returns>
        DataSet GetStatInfo_Agent(int UserID);
        ...
        /// </summary>
        /// <returns></returns>
        DataTable IsAndroidGameRevenue();
        /// <summary>
        /// 玩家税收
        /// </summary>
        /// <returns></returns>
        DataTable UnIsAndroidGameRevenue();
        /// <summary>
        /// 获取每个房间税收
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        DataTable IsAndroidRoomRevenue();
        /// <summary>
        ///玩家房间税收
        /// </summary>
        /// <returns></returns>
        DataTable UnIsAndroidRoomRevenue();
        /// <summary>
        /// 获取每个游戏损耗
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="gameScoreInfo"></param>
        void UpdateInsure(GameScoreInfo gameScoreInfo);
        ...
        /// <param name="buildID"></param>
        /// <returns></returns>
        // RecordSpreadInfo GetRecordSpreadInfo(int UserId);
        ...
        void InsertSpreadAddress(SpreadAdd spreadAdd);
        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="sqlQuery"></param>
        void DeleteSpreadAddress(string sqlQuery);
        ...
        /// <param name="orderby"></param>
        /// <returns></returns>
        PagerSet GetSpreadAddressList(int pageIndex, int pageSize, string condition, string orderby);
        ...
        /// <param name="orderID"></param>
        /// <returns></returns>
        SpreadAdd GetSpreadAddressInfo(int id);

        /// <summary>
        /// 更新
        /// </summary>
        /// <param name="spreadAdd"></param>
        void UpdateSpreadAddress(SpreadAdd spreadAdd);
        #endregion

        PagerSet GetMobliePayList(int pageIndex, int pageSize, string condition, string orderby);


        Message GrantTreasureScore(string strUserIdList, int intGold, int intMasterID, string strReason, string strIP);

        PagerSet GetRecordGrantTreasureScoreList(int pageIndex, int pageSize, string condition, string orderby);

        #region 升级
        Message GrantRoomcard(string strUserIdList, int intRcard, int intMasterID, string strReason, string strIP);
        Message GrantRoomcard_Agent(string strUserIdList, int UserIDListCount, int intRcard, int intMasterID, string strReason, string strIP);

        PagerSet GetReportRecharge(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportGift(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportLoginLog(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportRichChange(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportPlayGame(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportGameWaste(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportAllSum(int pageIndex, int pageSize, Dictionary<string, object> conditions);
        PagerSet GetReportAllSum_Gamer(int pageIndex, int pageSize, Dictionary<string, object> conditions);
