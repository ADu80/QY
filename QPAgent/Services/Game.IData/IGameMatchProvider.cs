...
namespace Game.IData
{
    public interface IGameMatchProvider
    {
        ...
        PagerSet GetRecordMatchInoutList(int pageIndex, int pageSize, string condition, string orderby);

        DataSet GetMatchStat(string whereQuery);

        DataTable GetMatchNoStat(int matchNo);
        ...
        void InsertMatchInfo( MatchInfo gameMatch );

           /// <summary>
        /// 更新比赛
        /// </summary>
        /// <param name="gameMatch"></param>
        void UpdateMatchInfo( MatchInfo gameMatch );
