...
namespace Game.IData
{
    ...
    public interface IAccountsDataProvider //: IProvider
    {
        ...
        PagerSet GetAccountsList1(int pageIndex, int pageSize, string condition, string orderby);
        PagerSet GetAccountsList2(int pageIndex, int pageSize, string condition, string orderby);
        /// <summary>
        /// 获得用户名
        /// </summary>
        ...
        /// <param name="datum">IndividualDatum实体</param>
        /// <returns></returns>
        Message AddSilver(AccountsInfo account, IndividualDatum datum);
        Message AddSilver(int UserID, int InvitCode, AccountsInfo account, IndividualDatum datum, Base_Users users);
        Message AddSilverUser(AccountsInfo account, IndividualDatum datum);
        Message AddVipUser(AccountsInfo account, IndividualDatum datum);
        #endregion        
        ...
        PagerSet GetIdentifierList(int pageIndex, int pageSize, string condition, string orderby);
        #endregion
        ...
        /// <returns></returns>
        AccountsInfo GetLastLogonMachine(string LastLogonMachine);
        ...
        /// </summary>
        /// <param name="sqlQuery"></param>
        void DeleteAccountsProvider(string sqlQuery);
