...
namespace Game.Facade
{
    ...
    public class AdminCookie
    {
        ...
        public static void SetUserCookieOld(Base_Users user)
        {
            ...
            dic.Add(Base_Users._AgentID, user.AgentID);
            dic.Add(Base_Users._VipID, user.VipID);
            Add(dic, 30);
        ...
        public static void ClearUserSession()
        {
            if (HttpContext.Current.Session != null)
            {
                ...
                HttpContext.Current.Session.Remove("IsBand");
                HttpContext.Current.Session.Remove("AgentID");
                HttpContext.Current.Session.Remove("VipID");
            }
