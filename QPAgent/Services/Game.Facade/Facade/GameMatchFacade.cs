...
namespace Game.Facade
{
    ...
    public class GameMatchFacade
    {
        ...
        {
            return this.gameMatchData.GetRecordMatchInoutList(pageIndex, pageSize, condition, orderby);
        }
        ...
        {
            return this.gameMatchData.GetMatchStat(whereQuery);
        }


        public DataTable GetMatchNoStat(int matchNo)
        {
            return this.gameMatchData.GetMatchNoStat(matchNo);
        }
