...
namespace Game.Facade
{
    ...
    public class AccountsFacade
    {
        ...
        {
            return aideAccountsData.IsAccountsExist(accounts);
        }
        /// <summary>
        /// 判断用户名是否存在
        /// </summary>
        ...
        {
            return aideAccountsData.IsNickNameExist(nickName);
        }
        /// <summary>
        /// 分页获取所有玩家列表
        /// </summary>
        ...
        {
            return aideAccountsData.GetAccountsList1(pageIndex, pageSize, condition, orderby);
        }
        public PagerSet GetAccountsList2(int pageIndex, int pageSize, string condition, string orderby)
        {
            return aideAccountsData.GetAccountsList2(pageIndex, pageSize, condition, orderby);
        }
        /// <summary>
        /// 冻结玩家
        /// </summary>
        ...
        {
            return aideAccountsData.GetIdentifierList(pageIndex, pageSize, condition, orderby);
        }
        #endregion
        ...
        {
            return aideAccountsData.GetLastLogonMachine(LastLogonMachine);
        }
        ...
        {
            aideAccountsData.DeleteAccountsProvider(sqlQuery);
        }
