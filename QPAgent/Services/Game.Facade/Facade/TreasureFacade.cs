...
namespace Game.Facade
{
    ...
    public class TreasureFacade
    {
        ...
        {
            return aideTreasureData.InsureTransfer(srcUserID, insurePass, dstUserID, TradeScore, minTradeScore, clientIP, note);
        }
        #region 充值相关
        /// <summary>
        /// 获取实卡类型记录列表
        ...
        {
            return aideTreasureData.PlyOrderList(pageIndex, pageSize, condition, orderby);
        }
        ...
        {
            aideTreasureData.DeletePlyOrder(sqlQuery);
        }
        ...
        {
            return aideTreasureData.GrantTreasure_Agent(byUserID, strUserIdList, UserIDListCount, intGold, intMasterID, strReason, strIP);
        }
        /// <summary>
        /// 赠送积分
        /// </summary>
        ...
        {
            return aideTreasureData.GetStatInfo2(UserID);
        }

        public DataSet GetStatInfo_Admin()
        {
            return aideTreasureData.GetStatInfo_Admin();
        }
        public DataSet GetStatInfo_Agent(int UserID)
        {
            return aideTreasureData.GetStatInfo_Agent(UserID);
        }
        /// <summary>
        /// 获取每个游戏税收
        /// </summary>
        ...
        {
            return aideTreasureData.IsAndroidGameRevenue();
        }
        /// <summary>
        /// 玩家税收
        /// </summary>
        ...
        {
            return aideTreasureData.UnIsAndroidGameRevenue();
        }
        /// <summary>
        /// 获取每个房间税收
        /// </summary>
        ...
        {
            return aideTreasureData.IsAndroidRoomRevenue();
        }
        /// <summary>
        ///玩家房间税收
        /// </summary>
        ...
        {
            return aideTreasureData.UnIsAndroidRoomRevenue();
        }
        /// <summary>
        /// 获取每个游戏损耗
        /// </summary>
        ...
        {
            aideTreasureData.UpdateInsure(gameScoreInfo);
        }
        ...
        //{
        //   return aideTreasureData.GetRecordSpreadInfo(UserId);
        //}
        ...
        {
            return aideTreasureData.GetSpreadAddressInfo(id);
        }
        ...
        /// 更新
        /// </summary>
        /// <param name="spreadAdd"></param>
        /// <returns></returns>
        public Message UpdateSpreadAddress(SpreadAdd spreadAdd)
        {
            aideTreasureData.UpdateSpreadAddress(spreadAdd);
            return new Message(true);
        }
        /// <summary>
        /// 新增
        ...
        public Message InsertSpreadAddress(SpreadAdd spreadAdd)
        {
            aideTreasureData.InsertSpreadAddress(spreadAdd);
            return new Message(true);
        }
        ...
        {
            aideTreasureData.DeleteSpreadAddress(sqlQuery);
        }
        ...
        {
            return aideTreasureData.GetSpreadAddressList(pageIndex, pageSize, condition, orderby);
        }
        ...
        {
            return aideTreasureData.GetMobliePayList(pageIndex, pageSize, condition, orderby);
        }


        public Message GrantTreasureScore(string strUserIdList, int intGold, int intMasterID, string strReason, string strIP)
        {
            return aideTreasureData.GrantTreasureScore(strUserIdList, intGold, intMasterID, strReason, strIP);
        }


        public PagerSet GetRecordGrantTreasureScoreList(int pageIndex, int pageSize, string condition, string orderby)
        {
            return aideTreasureData.GetRecordGrantTreasureScoreList(pageIndex, pageSize, condition, orderby);
        }

        public Message GrantRoomcard(string strUserIdList, int intRcard, int intMasterID, string strReason, string strIP)
        {
            return aideTreasureData.GrantRoomcard(strUserIdList, intRcard, intMasterID, strReason, strIP);
        }
