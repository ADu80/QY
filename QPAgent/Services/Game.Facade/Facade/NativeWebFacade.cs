...
namespace Game.Facade
{
    ...
    public class NativeWebFacade //: BaseFacadeProvider
    {
        ...
        {
            return aideNativeWebData.GetContentist(pageIndex, pageSize, condition, orderby);
        }


        public Contents GetContentInfo(int id)
        {
            return aideNativeWebData.GetContentInfo(id);
        }
        ...
        /// </summary>
        /// <param name="news"></param>
        public Message InsertContent(Contents info)
        {
            aideNativeWebData.InsertContent(info);
            return new Message(true);
        }
        ...
        /// </summary>
        /// <param name="news"></param>
        public Message UpdateContent(Contents info)
        {
            aideNativeWebData.UpdateContent(info);
            return new Message(true);
        }
        ...
        {
            aideNativeWebData.DeleteContent(sqlQuery);
        }
        #endregion
        ...
        {
            return aideNativeWebData.GetRewardList(pageIndex, pageSize, condition, orderby);
        }

        public Message InsertReward(Reward info)
        {
            aideNativeWebData.InsertReward(info);
            return new Message(true);
        }

        public Message UpdateReward(Reward info)
        {
            aideNativeWebData.UpdateReward(info);
            return new Message(true);
        }

        public Reward GetRewardInfo(int Id)
        {
            return aideNativeWebData.GetRewardInfo(Id);
        }
        #endregion
    }
}
