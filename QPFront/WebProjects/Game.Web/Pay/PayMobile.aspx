    ...
    <div id="content">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                {
                    case "1":
                        $("#rbPayMType1").attr("checked", "checked");
                        $("#lblPayMType1").attr("class", "mlink");
                        break;
                    case "2":
                        $("#rbPayMType2").attr("checked", "checked");
                        $("#lblPayMType2").attr("class", "mlink");
                        break;
                    case "3":
                        $("#rbPayMType3").attr("checked", "checked");
                        $("#lblPayMType3").attr("class", "mlink");
                        break;
                    default:
                        break;
                }
		...
		<div class="content">
		    ...
		    <p style="text-align:left;padding-bottom:8px;">
			    ...
			    <label id="lblPayMType1" class="mlink1" for="rbPayMType1" hidefocus="true">神州行充值卡</label>
