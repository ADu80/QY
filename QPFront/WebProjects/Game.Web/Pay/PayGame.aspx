    ...
    <div id="content">
            ...
            $(document).ready(function() {
                ...
                switch (type) {
                    case "1":
                        ...
                        $("#rbPayGType1").parent().attr("class", "hand");
                        break;
                    case "2":
                        $("#rbPayGType2").attr("checked", "checked");
                        $("#rbPayGType2").parent().attr("class", "hand");
                        break;
                    case "3":
                        $("#rbPayGType3").attr("checked", "checked");
                        $("#rbPayGType3").parent().attr("class", "hand");
                        break;
                    case "4":
                        $("#rbPayGType4").attr("checked", "checked");
                        $("#rbPayGType4").parent().attr("class", "hand");
                        break;
                    case "5":
                        $("#rbPayGType5").attr("checked", "checked");
                        $("#rbPayGType5").parent().attr("class", "hand");
                        break;
                    default:
                        break;
                }
		...
		<div class="content">
		    ...
		    <p style="text-align:left;padding-bottom:8px;">
			  	...
			  	<label class="gray"><input type="radio" id="rbPayGType1" name="rbPayGType" runat="server" value="C"/>盛大一卡通</label>
        ...
        <div class="pay_tips_t" style="text-align:left;">
			...
			<p style="padding-bottom:8px;">2、充值过程中，浏览器会跳转至银行页面，支付成功后，会自动返回网站，如果没有跳转或是弹出充值成功的页面，请您不要关闭充值窗口。</p>
