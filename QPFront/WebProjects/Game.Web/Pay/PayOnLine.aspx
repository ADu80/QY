<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayOnLine.aspx.cs" Inherits="Game.Web.Pay.PayOnLine" %>
...
<script type="text/javascript">
    ...
    function hintMessage(hintObj,error,message){
		...
		<form id="fmStep2" runat="server" action="https://www.99bill.com/gateway/recvMerchantInfoAction.htm">
	     <div class="pay_tips">
            <p>
            ...
            <p id="pnlContinue" runat="server">
                <input id="btnReset1" type="button" value="继续充值" onclick="goURL('/Pay/PayOnLine.aspx');" class="btn_home_4blue" />
            </p>
        </div>        
    </form>
