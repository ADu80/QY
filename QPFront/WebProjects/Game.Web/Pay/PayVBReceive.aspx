...
<!--左边部分结束-->
    ...
    <div id="content">
		...
		<div class="content">
		    <div class="textBox">
				<div class="box">
					<div class="title" style="text-align:left;"><asp:Literal ID="litMsg" runat="server"></asp:Literal></div>
					<div class="info">
						<ul>
						    <li><span>订 单 号：</span><asp:Label ID="lblOrderID" runat="server"></asp:Label></li>
						    <li><span>游戏帐号：</span><asp:Label ID="lblAccounts" runat="server"></asp:Label></li>
