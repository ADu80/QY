...
<body>
            ...
            <div class="newsBody">
                ...
                <div class="tgBg">
                    ...
                    <div class="content">
                        ...
                        （3）推荐玩家推广业绩的<%= balanceRate*100%>%。当您所推荐的玩家，也推荐了其他人时,他（她）每次结算推广业绩时（将推广获得的金币转入游戏帐户中）,系统同时赠送您<%= balanceRate*100%>%的金额，他的提成收入保持不变。这样,您间接推荐的玩家都有可能为您带来业绩。<br />
                        <span class="bold">例如：您推荐了玩家A，A又推荐了好多其他的玩家。当A结算业绩时，获得了2000万金币提成，您的业绩同时也增加<%= 2000 * balanceRate%>万金币</span></div>
                    <div class="tgTitle1 lan f14 bold">
                        3、推广员业绩查询</div>
                    <div class="content">
    ...
    <script>
        $('.header .nav ul li.nav-tg').addClass('active');
    </script>
</body>
</html>
