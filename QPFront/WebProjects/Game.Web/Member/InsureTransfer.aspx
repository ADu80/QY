<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsureTransfer.aspx.cs"
    Inherits="Game.Web.Member.InsureTransfer" %>
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#txtScore").formValidator().inputValidator({min:minScore,type:"number",onerror:"抱歉，您每笔转出数目最少"+minScore+"币！"})
        ...
        <div class="userBg">
            ...
            <div class="mainRight2">
                <div class="userRigthBody">
                    <div class="userRigthTitle">
                        会员中心 - 保险柜服务 - 转账</div>
                    <div class="userRigthBg">
                        <!--转帐开始-->
                        <form name="form1" id="form1" runat="server">
                        <div class="title f14 bold lan">
                            财富信息</div>
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    保险柜存款：<asp:Label ID="lblInsureScore" runat="server" Text="0"></asp:Label>
                                    金币 <a href="/Pay/PayIndex.aspx" class="ll">我要充值</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    现金余额：<asp:Label ID="lblScore" runat="server" Text="0"></asp:Label>
                                    金币
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="400px" colspan="2" align="center" style="padding-left: 10px;">
                                    <input type="radio" id="radType1" name="radType" value="0" checked="true" runat="server" /><label
                                        for="radType1" hidefocus="true">按用户昵称</label>
                                    <input type="radio" id="radType2" name="radType" value="1" runat="server" /><label
                                        for="radType2" hidefocus="true">按ＩＤ号码</label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtInsurePass" runat="server" TextMode="Password" CssClass="text"
                                        Width="149"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td>
                                    <asp:TextBox ID="txtNote" runat="server" CssClass="beizhu" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="btnUpdate" Text="确定转账" runat="server" CssClass="bnt lan bold" OnClick="btnUpdate_Click" />
                                </td>
                            </tr>
                        </table>
                        <br />
