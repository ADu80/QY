...
namespace Game.Web.Member
{
    public partial class ConvertMedalRecord : UCPageBase
    {
        ...
        private void DataBindInsure( )
        {
            ...
            sWhere.AppendFormat( " AND CollectDate >= '{0}' AND CollectDate <= '{1}'", Convert.ToDateTime( this.txtStartDate.Text.Trim() + " 00:00:00" ), Convert.ToDateTime( this.txtEndDate.Text.Trim() + " 23:59:59" ) );
