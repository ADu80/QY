...
<div class="clear"></div>					
		...
		<div class="mainRight2">
			<div class="userRigthBody">
				<div class="userRigthTitle">会员中心 - 保险柜服务 - 魅力兑换</div>
	                ...
	                <td height="139" background="/images/contestBg1.jpg">
	                    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>                            
                            ...
                            <td  class="lineBottom"><asp:Label ID="lblTotalLoves" runat="server"></asp:Label></td>
                            <td align="right"  class="lineBottom">已兑换魅力值：</td>
                            <td  class="lineBottom"><asp:Label ID="lblExchangeLoves" runat="server"></asp:Label></td>
                          </tr>
                          <tr>
                            <td align="right">剩余魅力值：</td>
                            <td class="hong bold"><asp:Label ID="lblUnExchangeLoves" runat="server"></asp:Label></td>
                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="loginHint">
                      <tr class="bold hui3">
                        ...
                        <td width="26%" align="center"><asp:TextBox ID="txtPresent" runat="server" CssClass="text"></asp:TextBox></td>
