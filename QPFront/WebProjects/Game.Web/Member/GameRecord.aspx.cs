...
{
    public partial class GameRecord : UCPageBase
    {
        #region 继承属性
        ...
        private void BindInfoData()
        {
            ...
            {
                sWhere.AppendFormat( " AND StartTime >= '{0}'", Convert.ToDateTime( CtrlHelper.GetText( txtStartDate ) ) );
            }
        ...
        protected void rptDrawInfoList_ItemDataBound( object sender, RepeaterItemEventArgs e )
        {
            if( ( e.Item.ItemType == ListItemType.Item ) || ( e.Item.ItemType == ListItemType.AlternatingItem ) )
            {
                ...
                PagerSet pagerSet = treasureFacade.GetDrawScoreRecord( string.Format( " WHERE DrawID={0} AND UserID={1}", dataItem["DrawID"].ToString(), Fetch.GetUserCookie().UserID ), 1, 20 );
