...
<%--                <% if (Fetch.GetUserCookie() == null)
            ...
            <div class="mainRight2">
                <div class="userRigthBody contentbody">
                    <div class="userRigthTitle">首页 - 帐号服务中心 - 会员服务</div>
                    <div class="userRigthBg">
                        <div class="title f14 bold lan">基本信息</div>
                        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="4">尊敬的 <span class="hong bold">
                                    <asp:Label ID="lblAccounts" runat="server"></asp:Label></span> ,欢迎您来到用户个人中心。</td>
                            </tr>
                            <tr>
                                <td width="15%" align="right" bgcolor="#f7f9fd">昵 　 称：</td>
                                <td width="29%" bgcolor="#f7f9fd">
                                    <asp:Label ID="lblNickName" runat="server"></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" bgcolor="#F7F9FD">
                                    <asp:Label ID="lblUnderWrite" runat="server"></asp:Label></td>
                            </tr>
                        </table>
                        <br />
                        <br />
