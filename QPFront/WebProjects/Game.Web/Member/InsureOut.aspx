				...
				<!--取款开始-->
	              ...
	              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td><asp:TextBox ID="txtInsurePass" runat="server" CssClass="text" TextMode="Password" Width="149"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        <asp:Button ID="btnUpdate" Text="取出金币" runat="server" CssClass="bnt lan bold" 
