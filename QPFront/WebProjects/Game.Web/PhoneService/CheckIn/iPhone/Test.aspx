<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="Game.Web.PhoneService.CheckIn.iPhone.Test" %>
    ...
    <div class="bj">
        <div class="main">
            ...
            <div class="m_b">
                ...
                <div class="tj">
                    <asp:Button ID="btnCheck" runat="server" CssClass="textput"/>
