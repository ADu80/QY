...
<body>
    ...
    <div class="userRigthBg2">
        ...
        <div class="userRigthBg2">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#BAD7E5"
                class="leftTop">
                <tr align="center" class="bold">
                    <td class="leftTop trBg" style="width: 40%;">
                        游戏名称
                    </td>
                    <td class="leftTop trBg" style="width: 40%;">
                        积分
                    </td>
                    <td class="leftTop trBg" style="width: 20%;">
                        清零
                    </td>
                </tr>
                <asp:Repeater ID="rptScoreList" runat="server" OnItemCommand="rptScoreList_ItemCommand">
                    <ItemTemplate>
                        <tr align="center" class="trBg1">
                            ...
                            <td>
                                <asp:LinkButton ID="btnClear" runat="server" CommandName="Clear" CommandArgument='<%# Eval("KindID") %>'
                                    OnClientClick="return confirm('确定要清零吗?')" Text="清零" CssClass="lan"></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
