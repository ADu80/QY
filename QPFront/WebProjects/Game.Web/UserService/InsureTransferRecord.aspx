...
<body>
<div class="userRigthBg2" style="width:452px;">
	<!--存款开始-->
	  	<br />
          ...
          <tr align="center" class="bold">
                ...
                <td class="leftTop trBg">汇款人昵称</td>
                <td class="leftTop trBg">收款人昵称</td>
              ...
              <asp:Repeater ID="rptInsureList" runat="server">
                <ItemTemplate>
                   <tr align="center" class="trBg1">
                        ...
                        <td><%# GetNickNameByUserID( Convert.ToInt32( Eval( "SourceUserID" ) ) )%></td>  
                        <td><%# GetNickNameByUserID( Convert.ToInt32( Eval( "TargetUserID" ) ) )%></td>  
