...
namespace Game.Web.UserService
{
    public partial class USPayRecord : System.Web.UI.Page
    {
        ...
        private void BindPayData( )
        {
            ...
            sWhere.AppendFormat( " AND ApplyDate >= '{0}' AND ApplyDate <= '{1}'", Convert.ToDateTime( CtrlHelper.GetText( txtStartDate ) + " 00:00:00" ), Convert.ToDateTime( CtrlHelper.GetText( txtEndDate ) + " 23:59:59" ) );
