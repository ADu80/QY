    ...
    <script type="text/javascript">
        ...
        function checkAccounts(){
            ...
            if (GetByteLength($("#txtAccounts").val()) < 6 || GetByteLength($("#txtAccounts").val()) > 32) {
                hintMessage("txtAccountsTip","error","用户名的长度为6-32个字符");
                return false;
            }
            ...
            $.ajax({
                ...
                success: function(json) {
                    ...
                    if (json.success == "error") {
                        ...
                        hintMessage("txtNicknameTip", "error", "此昵已被注册!");
        ...
        function checkLoginConPass(){
            ...
            if($("#txtLogonPass2").val() != $("#txtLogonPass").val()){
                hintMessage("txtLogonPass2Tip","error","两次输入的登陆密码不一致");
                return false;
            }
        ...
        function checkInsureConPass(){
            ...
            if($("#txtInsurePass2").val() != $("#txtInsurePass1").val()){
                hintMessage("txtInsurePass2Tip","error","两次输入的银行密码不一致");
                return false;
            }
        ...
        $(document).ready(function() {
            ...
            $('#btnSwitchFace').dialog({ id: 'winUserfaceList', title: '更换头像', width: 540, height: 385, content: 'url:/FaceList.aspx' });
        });
    </script>
</head>
<body>
	  ...
	  <div class="regBg">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mtop13">
			  <tr>
				...
				<td width="226"><asp:TextBox runat="server" ID="txtAccounts" CssClass="text width200"></asp:TextBox><span class="hong">&nbsp;*</span></td>
			    <td width="284"><span id="txtAccountsTip"></span></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</td>
				<td><asp:TextBox ID="txtNickname" runat="server" CssClass="text width200"></asp:TextBox><span class="hong">&nbsp;*</span></td>
			    <td><span id="txtNicknameTip" class="tipsRight"></span></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">形&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;象：</td>
				<td>
			  ...
			  <tr>
				<td align="right" class="f14">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
				<td>
			...
			<!--登录密码开始-->
			<div class="title lan f14 bold mtop13">安全</div>
			<div >
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mtop13">	
			  <tr>
				<td width="230" align="right" class="f14">安全等级：</td>
				<td width="226"><span class="safe0" id="lblLogonPassSafeRank"></span></td>
			    <td width="284"></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
				<td><asp:TextBox ID="txtLogonPass" runat="server" TextMode="Password" CssClass="text width200"></asp:TextBox><span class="hong" >&nbsp;*</span></td>
			    <td><span id="txtLogonPassTip"></span></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">确认密码：</td>
				<td><asp:TextBox ID="txtLogonPass2" runat="server" TextMode="Password" CssClass="text width200"></asp:TextBox><span class="hong">&nbsp;*</span></td>
			    <td><span id="txtLogonPass2Tip"></span></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">安全等级：</td>
				<td><span class="safe0" id="lblInsurePassSafeRank"></span></td>
			    <td></td>
			  </tr> 
			  <tr>
				<td align="right" class="f14">保险柜密码：</td>
				<td><asp:TextBox ID="txtInsurePass1" runat="server" TextMode="Password" CssClass="text width200"></asp:TextBox><span class="hong">&nbsp;*</span></td>
			    <td><span id="txtInsurePass1Tip"></span></td>
			  </tr>
			  <tr>
				<td align="right" class="f14">确认密码：</td>
				<td><asp:TextBox ID="txtInsurePass2" runat="server" TextMode="Password" CssClass="text width200"></asp:TextBox><span class="hong">&nbsp;*</span></td>
			  ...
			  <tr>
			    ...
			    <td colspan="2">
			        ...
			        <img src="ValidateImage.aspx"id="picVerifyCode" height="23px" style="cursor:pointer;border: 1px solid #333333;vertical-align:text-bottom;" onclick="UpdateImage()" title="点击更换验证码图片!"/><span class="hong">&nbsp;*</span>
			...
			<!--推荐人开始-->
			<div class="title lan f14 bold mtop13">其他</div>
			<div >
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mtop13">	
			  <tr>
		      ...
		      <tr>
			    ...
			    <td><asp:TextBox ID="txtCompellation" runat="server" CssClass="text width200"></asp:TextBox></td>
			    <td><span id="txtCompellationTip"></span></td>
		      </tr>	
		      <tr>
			    <td align="right" class="f14">身份证号：</td>
			    <td><asp:TextBox ID="txtPassPortID" runat="server" CssClass="text width200"></asp:TextBox></td>
