namespace Game.Kernel
{
    ...
    public abstract class BaseDataProvider //: BaseProvider
    {
        ...
        {
            return this.PagerHelper.RunProc(proc, pageIndex, pageSize, conditions);
        }


        protected DataSet RunProcDs(string proc, Dictionary<string, object> conditions)
        {
            return this.PagerHelper.RunProcDs(proc, conditions);
        }
        protected DataSet RunProcDs(string proc)
        {
            return this.PagerHelper.RunProcDs(proc);
        }
    }
}
