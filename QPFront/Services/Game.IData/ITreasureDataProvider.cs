...
namespace Game.IData
{
    ...
    public interface ITreasureDataProvider //: IProvider
    {
        ...
        #region 充值
        int PayOrderAdd(Dictionary<string, object> conditions);
        int PayOrderEdit(Dictionary<string, object> conditions);
        int PayOrderGet(Dictionary<string, object> conditions);
        PayOrder PayOrderArr(Dictionary<string, object> conditions);
        PayOrder PayOrderArrByChannel(Dictionary<string, object> conditions);
        #endregion
    }
}
