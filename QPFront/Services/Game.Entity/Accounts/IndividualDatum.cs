...
namespace Game.Entity.Accounts
{
	...
	/// </summary>
	[Serializable]
	public partial class IndividualDatum  :UserInfo
	{
		#region 常量
		...
		/// 表名
		/// </summary>
		public new const string Tablename = "IndividualDatum" ;
		...
		/// 真实姓名
		/// </summary>
		public new const string _Compellation = "Compellation" ;
		...
		/// 真实姓名
		/// </summary>
		public new string Compellation
		{
