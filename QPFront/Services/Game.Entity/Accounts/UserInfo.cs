...
namespace Game.Entity.Accounts
{
	...
	public partial class UserInfo  
	{
        ...
        public UserInfo(int userID, string accounts, int gameID, string logonPasswd)
        {
            m_userID = userID;
            m_accounts = accounts;
            m_gameID = gameID;
        ...
        public UserInfo(UserTicketInfo userTicket)
            : this(userTicket.UserID, userTicket.Accounts, userTicket.GameID, userTicket.LogonPass)
        {
        }
