...
namespace Game.Data.Factory
{
    ...
    public class ClassFactory
    {
        ...
        public static IPlatformManagerProvider GetIPlatformManagerProvider()
        {
            return ProxyFactory.CreateInstance<PlatformManagerProvider>(ApplicationSettings.Get("DBPlatformManager"));
        }
