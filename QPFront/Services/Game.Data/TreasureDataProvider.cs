...
namespace Game.Data
{
    ...
    public class TreasureDataProvider : BaseDataProvider, ITreasureDataProvider
    {
        ...
        {
            StringBuilder sqlQuery = new StringBuilder();
            sqlQuery.Append("SELECT TOP 10 Score, NickName, Nullity ")
        ...
        public int PayOrderAdd(Dictionary<string, object> conditions)
        {
            ...
            int r = Database.RunProc("PayOrder_P_Add", prams);
        ...
        public int PayOrderEdit(Dictionary<string, object> conditions)
        {
            ...
            int r = Database.RunProc("PayOrder_P_Edit", prams);
        ...
        public int PayOrderGet(Dictionary<string, object> conditions)
        {
            ...
            prams.Add(Database.MakeOutParam("myPayState", typeof(int)));
            prams.Add(Database.MakeOutParam("myPayType", typeof(int)));
            prams.Add(Database.MakeOutParam("myBuyCount", typeof(int)));
            prams.Add(Database.MakeOutParam("myBackCount", typeof(int)));
            prams.Add(Database.MakeOutParam("myUserID", typeof(int)));
            prams.Add(Database.MakeOutParam("myPresent", typeof(int)));
            prams.Add(Database.MakeOutParam("myChannelOrderID", typeof(string)));

            int r = Database.RunProc("PayOrder_P_Get", prams);
            var getId = prams[1].Value;
            return int.Parse(getId.ToString());
        }

        public PayOrder PayOrderArrByChannel(Dictionary<string, object> conditions)
        {
            var prams = new List<DbParameter>();
            foreach (var item in conditions)
            {
            ...
            prams.Add(Database.MakeOutParam("myUserID", typeof(int)));
            prams.Add(Database.MakeOutParam("myPresent", typeof(int)));
            prams.Add(Database.MakeOutParam("myOrderID", typeof(string), 64));

            int r = Database.RunProc("PayOrder_P_Get_Channel", prams);
            var state = prams[1].Value.ToString();
            if (state == "-1")
            {
                return null;
            }
            else
            {
                ...
                model.ChannelOrderID = prams[0].Value.ToString();
                model.PayState = prams[1].Value.ToString();
                model.PayType = prams[2].Value.ToString();
                model.BuyCount = prams[3].Value.ToString();
                model.BackCount = prams[4].Value.ToString();
                model.UserID = prams[5].Value.ToString();
                model.Present = prams[6].Value.ToString();
                model.OrderID = prams[7].Value.ToString();
                return model;
            }
        }

        public PayOrder PayOrderArr(Dictionary<string, object> conditions)
        {
            var prams = new List<DbParameter>();
            foreach (var item in conditions)
            {
            ...
            prams.Add(Database.MakeOutParam("myUserID", typeof(int)));
            prams.Add(Database.MakeOutParam("myPresent", typeof(int)));
            prams.Add(Database.MakeOutParam("myChannelOrderID", typeof(string), 64));
            ...
            {
                PayOrder model = new PayOrder();
                model.OrderID = prams[0].Value.ToString();
                model.PayState = prams[1].Value.ToString();
                model.PayType = prams[2].Value.ToString();
                model.BuyCount = prams[3].Value.ToString();
                model.BackCount = prams[4].Value.ToString();
                model.UserID = prams[5].Value.ToString();
                model.Present = prams[6].Value.ToString();
                model.ChannelOrderID = prams[7].Value.ToString();
                return model;
            }
