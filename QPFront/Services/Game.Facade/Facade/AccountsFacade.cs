...
namespace Game.Facade
{
    ...
    public class AccountsFacade
    {
        ...
        public Message LogonByMobile(UserInfo user, bool isEncryptPasswd)
        {
            Message umsg;
            if (!isEncryptPasswd)
            {
            ...
            umsg = accountsData.LoginByMobile(user);
            return umsg;
        }

        public string GetAccountsByMobile(string mobile)
        {
            return accountsData.GetAccountsByMobile(mobile);
        }
        ...
        {
            return accountsData.GetAccountInfoByAccount(account);
        }

        public DataSet GetAccountInfoByGameID(string sqlQuery)
        {
            return accountsData.GetAccountInfoByGameID(sqlQuery);
        }
        ...
        {
            return accountsData.GetSystemStatusInfo(statusName);
        }
        ...
        {
            return accountsData.GetAccountList();
        }

        public DataTable GetAccountScoreInfoByUserID(int id)
        {
            return accountsData.GetAccountScoreInfoByUserID(id);
        }
        public DataTable GetAccountScoreInfoByGameID(int id)
        {
            return accountsData.GetAccountScoreInfoByGameID(id);
        }
        public DataTable GetAccountScoreInfoByAccount(string account)
        {
            return accountsData.GetAccountScoreInfoByAccount(account);
        }
        public DataTable GetAccountScoreInfoByNick(string nick)
        {
            return accountsData.GetAccountScoreInfoByNick(nick);
        }
    }
}
