...
IF  EXISTS(SELECT 1 FROM dbo.SysObjects WHERE id=OBJECT_ID('Districts') AND xtype='U')
	DROP TABLE Districts 
GO
CREATE TABLE Districts (  
  ID INT IDENTITY(1,1),
  DistrictsID VARCHAR(20) NOT NULL,  
...
INSERT INTO Districts(DistrictsID,DistrictsName,CityID)  
